...
export class SeedService implements OnApplicationBootstrap {
  ...
  private async seedLotes(
    ...
    const batch = [
      ...
      { codigo: 'LOT-RIO-2026-002',  tipoProductoId: cafeId,  campanaId: c2026, productorId: p[0].id, cantidadKg: 1400, estado: LoteEstado.POST_ADQUISICION, fechaAdquisicion: '2026-06-01', observaciones: 'Segunda entrega. Grano más pequeño, pendiente evaluación.' },
      ...
      { codigo: 'LOT-MEN-2026-001',  tipoProductoId: cafeId,  campanaId: c2026, productorId: p[2].id, cantidadKg: 3500, estado: LoteEstado.PRE_TRILLADO,     fechaAdquisicion: '2026-05-18', observaciones: 'Lote base dividido en sub-lotes por calidad.' },
      ...
      { codigo: 'LOT-MEN-2026-001B', tipoProductoId: cafeId,  campanaId: c2026, productorId: p[2].id, cantidadKg: 1550, estado: LoteEstado.POST_ADQUISICION, fechaAdquisicion: '2026-05-18', observaciones: 'Sub-lote B — grano estándar. Pendiente evaluación.' },
      { codigo: 'LOT-VAS-2026-001',  tipoProductoId: cafeId,  campanaId: c2026, productorId: p[3].id, cantidadKg: 1200, estado: LoteEstado.POST_ADQUISICION, fechaAdquisicion: '2026-05-25', observaciones: 'Café zonas mixtas. Perfil frutal y achocolatado.' },
      ...
      { codigo: 'LOT-MAM-2025-001',  tipoProductoId: cafeId,  campanaId: c2025, productorId: p[6].id, cantidadKg: 1750, estado: LoteEstado.POST_ADQUISICION, fechaAdquisicion: '2025-06-15', observaciones: 'Café 1900 msnm. Proceso honey. Notas a miel y durazno.' },
      { codigo: 'LOT-CON-2025-001',  tipoProductoId: cafeId,  campanaId: c2025, productorId: p[7].id, cantidadKg: 2100, estado: LoteEstado.POST_ADQUISICION, fechaAdquisicion: '2025-07-08', observaciones: 'Café bajo sombra en sistema agroforestal.' },
  ...
  private async seedMuestras(
    ...
    const ms = [
      await this.muestraRepo.save(this.muestraRepo.create({ codigo: 'MST-2026-CAFE-001', campanaId: c2026, productorId: p[0].id, loteId: lotes[0].id, loteFinalId: lfs[0].id, tipoMuestra: 'cafe', cantidadKg: 0.350, fechaRegistro: '2026-05-20', fechaCata: '2026-05-23', humedad: 10.8, rendimiento: 87.3, variedad: 'Caturra / Bourbon', proceso: 'Lavado', base: 'SCA 2020', estado: EstadoMuestra.COMPLETADA, puntajeFisico: 87.0, puntajeSensorial: 87.25, region: 'Jaén, Cajamarca', pais: 'Peru', añoCosecha: 2026, observaciones: 'Taza limpia. Acidez brillante, cuerpo cremoso, posgusto largo a cacao. Exportable.', activo: true })),
      await this.muestraRepo.save(this.muestraRepo.create({ codigo: 'MST-2026-CAFE-002', campanaId: c2026, productorId: p[2].id, loteId: lotes[5].id, loteFinalId: lfs[2].id, tipoMuestra: 'cafe', cantidadKg: 0.300, fechaRegistro: '2026-05-24', fechaCata: '2026-05-27', humedad: 11.1, rendimiento: 85.9, variedad: 'Geisha / Pache', proceso: 'Lavado', base: 'SCA 2020', estado: EstadoMuestra.COMPLETADA, puntajeFisico: 84.5, puntajeSensorial: 85.5, region: 'Satipo, Junín', pais: 'Peru', añoCosecha: 2026, observaciones: 'Perfil floral Geisha. Excelente acidez cítrica.', activo: true })),
      await this.muestraRepo.save(this.muestraRepo.create({ codigo: 'MST-2026-CAFE-003', campanaId: c2026, productorId: p[3].id, loteId: lotes[7].id, tipoMuestra: 'cafe', cantidadKg: 0.250, fechaRegistro: '2026-05-28', humedad: 11.8, variedad: 'Catimor', proceso: 'Lavado', base: 'SCA 2020', estado: EstadoMuestra.EN_PROCESO, puntajeFisico: 82.0, region: 'Oxapampa, Pasco', pais: 'Peru', añoCosecha: 2026, observaciones: 'Evaluación física completa. Pendiente sesión de catación.', activo: true })),
      await this.muestraRepo.save(this.muestraRepo.create({ codigo: 'MST-2026-CACAO-001', campanaId: c2026, productorId: p[1].id, loteId: lotes[2].id, loteFinalId: lfs[1].id, tipoMuestra: 'cacao', cantidadKg: 0.250, fechaRegistro: '2026-05-22', fechaCata: '2026-05-25', humedad: 7.2, rendimiento: 86.8, variedad: 'CCN-51 / Clon Nativo', proceso: 'Fermentado 5 días', base: 'IICTE 2023', estado: EstadoMuestra.COMPLETADA, puntajeFisico: 83.0, puntajeSensorial: 79.5, region: 'Tocache, San Martín', pais: 'Peru', añoCosecha: 2026, observaciones: 'Fino de aroma. Florales y frutas amarillas. Grado 1.', activo: true })),
      await this.muestraRepo.save(this.muestraRepo.create({ codigo: 'MST-2025-CAFE-001', campanaId: c2025, productorId: p[6].id, loteId: lotes[10].id, loteFinalId: lfs[5].id, tipoMuestra: 'cafe', cantidadKg: 0.400, fechaRegistro: '2025-06-10', fechaCata: '2025-06-14', humedad: 10.5, rendimiento: 88.4, variedad: 'Typica', proceso: 'Honey', base: 'SCA 2020', estado: EstadoMuestra.COMPLETADA, puntajeFisico: 88.5, puntajeSensorial: 90.0, region: 'Quillabamba, Cusco', pais: 'Peru', añoCosecha: 2025, observaciones: 'Extraordinario. Miel, durazno y vainilla. Cuerpo sedoso. Candidato concurso.', activo: true })),
      await this.muestraRepo.save(this.muestraRepo.create({ codigo: 'MST-2025-CACAO-001', campanaId: c2025, productorId: p[5].id, loteId: lotes[9].id, loteFinalId: lfs[4].id, tipoMuestra: 'cacao', cantidadKg: 0.500, fechaRegistro: '2025-05-18', fechaCata: '2025-05-22', humedad: 6.9, rendimiento: 88.1, variedad: 'Clon Nativo Fino de Aroma', proceso: 'Fermentado 7 días', base: 'IICTE 2023', estado: EstadoMuestra.COMPLETADA, puntajeFisico: 86.5, puntajeSensorial: 87.5, region: 'Juanjuí, San Martín', pais: 'Peru', añoCosecha: 2025, observaciones: 'Premium. Perfil excepcional. Ganadora concurso regional 2024.', activo: true })),
      await this.muestraRepo.save(this.muestraRepo.create({ codigo: 'MST-2024-CAFE-001', campanaId: c2024, productorId: p[9].id, loteId: lotes[13].id, loteFinalId: lfs[8].id, tipoMuestra: 'cafe', cantidadKg: 0.350, fechaRegistro: '2024-06-18', fechaCata: '2024-06-22', humedad: 10.2, rendimiento: 89.1, variedad: 'Geisha / Bourbon', proceso: 'Lavado', base: 'SCA 2020', estado: EstadoMuestra.COMPLETADA, puntajeFisico: 89.0, puntajeSensorial: 88.5, region: 'Rodríguez de Mendoza, Amazonas', pais: 'Peru', añoCosecha: 2024, observaciones: 'Geisha 88+ pts SCA. Exportado Nordic Approach Oslo.', activo: true })),
      await this.muestraRepo.save(this.muestraRepo.create({ codigo: 'MST-2026-CAFE-004', campanaId: c2026, productorId: p[0].id, loteId: lotes[1].id, loteFinalId: lfs[3].id, tipoMuestra: 'cafe', cantidadKg: 0.300, fechaRegistro: '2026-06-08', estado: EstadoMuestra.PENDIENTE, variedad: 'Caturra', proceso: 'Lavado', region: 'Jaén, Cajamarca', pais: 'Peru', añoCosecha: 2026, observaciones: 'Segunda entrega Ríos. Pendiente evaluación completa.', activo: true })),
    ];
