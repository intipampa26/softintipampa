...
const SEED_SKUS: SkuSeed[] = [
  // ── Café verde ────────────────────────────────────────────────────────────
  { codigo: 'CF001', nombre: 'Comunal Cofre Spot',        descripcion: 'Granos Café verde', unidad: 'KILOGRAMO', codigoHS: HS_CAFE,     requiereFito: true,  ...FDA_CAFE     },
  ...
  { codigo: 'CF004', nombre: 'Classic Raúl',              descripcion: 'Granos Café verde', unidad: 'KILOGRAMO', codigoHS: HS_CAFE,     requiereFito: true,  ...FDA_CAFE     },
  ...
  { codigo: 'CF006', nombre: 'Nuwa Tabí',                 descripcion: 'Granos Café verde', unidad: 'KILOGRAMO', codigoHS: HS_CAFE,     requiereFito: true,  ...FDA_CAFE     },
  ...
  { codigo: 'CF017', nombre: 'Nuwa Geisha',               descripcion: 'Granos Café verde', unidad: 'KILOGRAMO', codigoHS: HS_CAFE,     requiereFito: true,  ...FDA_CAFE     },
  ...
  { codigo: 'CF019', nombre: 'Cholo Power Geisha',        descripcion: 'Granos Café verde', unidad: 'KILOGRAMO', codigoHS: HS_CAFE,     requiereFito: true,  ...FDA_CAFE     },
  ...
  { codigo: 'CF021', nombre: 'Nusta Power Typica',        descripcion: 'Granos Café verde', unidad: 'KILOGRAMO', codigoHS: HS_CAFE,     requiereFito: true,  ...FDA_CAFE     },
  { codigo: 'CF022', nombre: 'Nusta Power Peche',         descripcion: 'Granos Café verde', unidad: 'KILOGRAMO', codigoHS: HS_CAFE,     requiereFito: true,  ...FDA_CAFE     },
  { codigo: 'CF023', nombre: 'Purumacho Geisha',          descripcion: 'Granos Café verde', unidad: 'KILOGRAMO', codigoHS: HS_CAFE,     requiereFito: true,  ...FDA_CAFE     },
  ...
  { codigo: 'CF026', nombre: 'Nusta Power Geisha',        descripcion: 'Granos Café verde', unidad: 'KILOGRAMO', codigoHS: HS_CAFE,     requiereFito: true,  ...FDA_CAFE     },
  ...
  { codigo: 'CA002', nombre: 'Chuncho Pumathy',           descripcion: 'Cacao en grano', unidad: 'KILOGRAMO', codigoHS: HS_CACAO_RAW, requiereFito: true,  ...FDA_CACAO    },
  { codigo: 'CA003', nombre: 'Blend Apecma',              descripcion: 'Cacao en grano', unidad: 'KILOGRAMO', codigoHS: HS_CACAO_RAW, requiereFito: true,  ...FDA_CACAO    },
  { codigo: 'CA004', nombre: 'Blend Chihuares',           descripcion: 'Cacao en grano', unidad: 'KILOGRAMO', codigoHS: HS_CACAO_RAW, requiereFito: true,  ...FDA_CACAO    },
  ...
  { codigo: 'CA009', nombre: 'CHUNCHO IL',                descripcion: 'Cacao en grano', unidad: 'KILOGRAMO', codigoHS: HS_CACAO_RAW, requiereFito: true,  ...FDA_CACAO    },
  ...
  { codigo: 'CA021', nombre: 'COPUAZU EL PROGRESO',       descripcion: 'Copuazu Pelado',  unidad: 'KILOGRAMO', codigoHS: HS_CACAO_RAW, requiereFito: false, ...FDA_COPUAZU  },
  { codigo: 'CA023', nombre: 'CHUNCHO PAVITITI',          descripcion: 'Cacao en grano', unidad: 'KILOGRAMO', codigoHS: HS_CACAO_RAW, requiereFito: true,  ...FDA_CACAO    },
  { codigo: 'CA030', nombre: 'Cacao Chuncho Pumathy',     descripcion: 'Cacao en grano', unidad: 'KILOGRAMO', codigoHS: HS_CACAO_RAW, requiereFito: true,  ...FDA_CACAO    },
  ...
  { codigo: 'CA019', nombre: 'MACAMBO ARTISRY',               descripcion: 'Macambo tostado',   unidad: 'KILOGRAMO', codigoHS: HS_MACAMBO,requiereFito: false, ...FDA_MACAMBO, soloOtros: true },
