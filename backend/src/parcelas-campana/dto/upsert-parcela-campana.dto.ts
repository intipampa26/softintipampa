import {
  IsInt, IsOptional, IsString, IsBoolean, IsNumber, MaxLength, Min,
} from 'class-validator';
import { Type } from 'class-transformer';

export class UpsertParcelaCampanaDto {
  ...
  @IsNumber() @IsOptional() @Type(() => Number) produccion?: number;
  ...
  @IsString() @IsOptional() observacionesCampana?: string;
}
