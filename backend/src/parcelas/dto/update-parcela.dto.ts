...
import { LatLngDto } from './create-parcela.dto';
...
export class UpdateParcelaDto {
  ...
  @IsEnum(ParcelaTipoProducto) @IsOptional() tipoProducto?: ParcelaTipoProducto;

  @IsBoolean() @IsOptional() activo?: boolean;
  @IsIn(['TIENE', 'NO TIENE', 'EN PROCESO']) @IsOptional() tienePpa?: string;
